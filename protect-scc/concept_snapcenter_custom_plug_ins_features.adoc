...
+
O SnapCenter usa a tecnologia Snapshot do NetApp com os plug-ins personalizados do SnapCenter para fazer backup de recursos. Os snapshots consomem espaço mínimo de storage.
