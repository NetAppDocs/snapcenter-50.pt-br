...
+
Você pode pesquisar o grupo de recursos inserindo o nome do grupo de recursos na caixa de pesquisa ou selecionando * *image:../media/filter_icon.gif["Ícone de filtro"] e, em seguida, selecionando a tag. Em seguida, pode selecionarimage:../media/filter_icon.gif["Ícone de filtro"] * * para fechar o painel do filtro.
